...
HIBP enables devices to share hyperlocal human‑intent metadata—such as commerce signals, community alerts, lost and found notices, environmental events, and infrastructure beacons—without accounts, logins, or centralized platforms.
...
- Reserved ranges for future versions and vendor‑specific intents  
...
- Protocol Overview (Information Network Website)  
